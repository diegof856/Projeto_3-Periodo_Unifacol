...
CREATE TABLE `usuario_normal` (
  `id_usuario_normal` int NOT NULL AUTO_INCREMENT,
  `id_usuario` int NOT NULL,
  PRIMARY KEY (`id_usuario_normal`,`id_usuario`),
  KEY `fk_usuario_normal_usuario1_idx` (`id_usuario`),
  CONSTRAINT `fk_usuario_normal_usuario1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
