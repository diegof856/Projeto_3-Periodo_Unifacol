...
CREATE TABLE `genero_filme` (
  ...
  KEY `fk_genero_has_filme_filme1_idx` (`id_filme`),
  KEY `fk_genero_has_filme_genero1_idx` (`id_genero`),
  CONSTRAINT `fk_genero_has_filme_filme1` FOREIGN KEY (`id_filme`) REFERENCES `filme` (`id_filme`),
  CONSTRAINT `fk_genero_has_filme_genero1` FOREIGN KEY (`id_genero`) REFERENCES `genero` (`id_genero`)
...
INSERT INTO `genero_filme` VALUES (16,8);
