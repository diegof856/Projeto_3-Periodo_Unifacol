...
CREATE TABLE `ator` (
  ...
  PRIMARY KEY (`id_ator`,`id_pessoa`),
  UNIQUE KEY `idator_UNIQUE` (`id_ator`),
  KEY `fk_ator_pessoa1_idx` (`id_pessoa`),
  CONSTRAINT `fk_ator_pessoa1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoa` (`id_pessoa`)
