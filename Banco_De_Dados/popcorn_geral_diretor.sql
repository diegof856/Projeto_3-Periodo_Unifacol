...
CREATE TABLE `diretor` (
  ...
  PRIMARY KEY (`id_diretor`,`id_pessoa`),
  UNIQUE KEY `iddiretor_UNIQUE` (`id_diretor`),
  KEY `fk_diretor_pessoa1_idx` (`id_pessoa`),
  CONSTRAINT `fk_diretor_pessoa1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoa` (`id_pessoa`)
...
INSERT INTO `diretor` VALUES (1,8);
